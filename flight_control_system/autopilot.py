...
class AP:
    ...
    def _command_allocation(self, axis: Axis, command_input: InputChannel) -> control.StateSpace:
    ...
    def build_ap(
        ...
        P_ap = control.series(G, C_ap)                                      # ny x 1

        # Closed loop: e = r - H_ap*y
        cl_y_cmd = control.feedback(P_ap, H_ap, sign=-1)                    # ny x 1
        ...
        cl_z = control.series(W_out, cl_y_cmd)                              # 1 x 1

        return cl_z, cl_y_cmd, C_ap